...
class Migration_remove_duplicate_links extends CI_Migration
{
	...
	//Remove duplicate attribute links
		$this->db->trans_start();
        //$this->db->query('SELECT item_id,definition_id,attribute_id');
        ...
        $duplicated_links = $this->db->query('SELECT item_id,definition_id,attribute_id FROM ospos_attribute_links');
